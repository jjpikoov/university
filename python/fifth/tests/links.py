...
# IMAGES
    ...
    def test_linkparser(self):
        print("linkparser")
        lpp = LinkParser('/home/jjpikoov/coding/python/RozszPython/fifth/website/relet.github.io/kivyMaps/configuration.html')
    ...
    def test_imageparser(self):
        print("imageparser")
        ip = ImageParser('/home/jjpikoov/coding/python/RozszPython/fifth/website/relet.github.io/kivyMaps/index.html')
