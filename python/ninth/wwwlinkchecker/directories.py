...
class dirHandler():
    ...
    def __init__(self, main_directory):
        """dirHandler works for given main_directory"""
        self.main_directory = main_directory

    def list_all_directories(self):
        """Lists all directories from main_directory"""
        self.result = []
    ...
    def all_html_files(self, in_directory):
        """Returns paths for html files in given dir"""
        self.result = []
    ...
    def all_files_with_extension(self, in_directory, *extensions):
        """Resturns paths for files with given extensions in dir"""
        self.result = []
        for f in os.listdir(in_directory):
